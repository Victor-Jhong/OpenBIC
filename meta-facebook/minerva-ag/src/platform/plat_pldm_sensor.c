...
pldm_sensor_info plat_pldm_sensor_vr_table[] = {
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEA * 2],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEA * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEA * 2 + 1],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEB * 2],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEB * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V75_TRVDD_ZONEB * 2 + 1],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM0_HBM2_HBM4 * 2],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM0_HBM2_HBM4 * 2],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM0_HBM2_HBM4 * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM0_HBM2_HBM4 * 2 + 1],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V9_TRVDD_ZONEA * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V9_TRVDD_ZONEA * 2 + 1],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V9_TRVDD_ZONEB * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P0V9_TRVDD_ZONEB * 2 + 1],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM1_HBM3_HBM5 * 2],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM1_HBM3_HBM5 * 2],
		},
	},
	{
		{
	...
	},
	{
		...
		.update_time = 0,
		{
			...
			.cache_status = PLDM_SENSOR_INITIALIZING,
			.pre_sensor_read_hook = pre_vr_read,
			.pre_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM1_HBM3_HBM5 * 2 + 1],
			.post_sensor_read_hook = post_vr_read,
			.post_sensor_read_args = &vr_pre_read_args[VR_INDEX_E_P1V1_VDDC_HBM1_HBM3_HBM5 * 2 + 1],
		},
	},
	{
		{
