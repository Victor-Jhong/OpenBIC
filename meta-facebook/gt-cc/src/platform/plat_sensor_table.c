...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_TEMP_NIC_0, sensor_dev_tmp75, I2C_BUS1, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[0] },
	{ SENSOR_NUM_TEMP_NIC_1, sensor_dev_tmp75, I2C_BUS2, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[1] },
	{ SENSOR_NUM_TEMP_NIC_2, sensor_dev_tmp75, I2C_BUS3, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[2] },
	{ SENSOR_NUM_TEMP_NIC_3, sensor_dev_tmp75, I2C_BUS4, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[3] },
	{ SENSOR_NUM_TEMP_NIC_4, sensor_dev_tmp75, I2C_BUS11, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[4] },
	{ SENSOR_NUM_TEMP_NIC_5, sensor_dev_tmp75, I2C_BUS12, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[5] },
	{ SENSOR_NUM_TEMP_NIC_6, sensor_dev_tmp75, I2C_BUS13, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[6] },
	{ SENSOR_NUM_TEMP_NIC_7, sensor_dev_tmp75, I2C_BUS14, NIC_ADDR, AMD_NIC_CHIP_TEMP_OFFSET,
	  is_nic_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0,
	  SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL, &pollara_init_args[7] },

	/* NIC optics 0-7 temperature sensor */
	{ SENSOR_NUM_TEMP_NIC_OPTICS_0, sensor_dev_tmp75, I2C_BUS1, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[0] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_1, sensor_dev_tmp75, I2C_BUS2, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[1] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_2, sensor_dev_tmp75, I2C_BUS3, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[2] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_3, sensor_dev_tmp75, I2C_BUS4, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[3] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_4, sensor_dev_tmp75, I2C_BUS11, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[4] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_5, sensor_dev_tmp75, I2C_BUS12, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[5] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_6, sensor_dev_tmp75, I2C_BUS13, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[6] },
	{ SENSOR_NUM_TEMP_NIC_OPTICS_7, sensor_dev_tmp75, I2C_BUS14, NIC_ADDR,
	  AMD_NIC_DR4_MODULE_TEMP_OFFSET, is_nic_optics_access, 0, 0, SAMPLE_COUNT_DEFAULT,
	  POLL_TIME_DEFAULT, ENABLE_SENSOR_POLLING, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &pollara_dr4_init_args[7] },
